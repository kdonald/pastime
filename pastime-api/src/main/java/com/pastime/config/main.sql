...
CREATE TABLE seasons (league integer,
  ...
  rosters_frozen boolean CONSTRAINT df_seasons_rosters_frozen DEFAULT false,
...
CREATE TABLE teams (league integer,
  ...
  removed boolean,
  franchise integer,  
  CONSTRAINT pk_teams PRIMARY KEY (league, season, number),
  ...
  CONSTRAINT uq_teams_team_slug UNIQUE (league, season, slug)  
);
...
CREATE TABLE team_members (league integer,
  ...
  CONSTRAINT fk_team_members_team FOREIGN KEY (league, season, team) REFERENCES teams(league, season, number) ON DELETE CASCADE,
...
CREATE TABLE team_member_invites (league integer,
  ...
  player integer,  
  accepted boolean NOT NULL CONSTRAINT df_team_member_invites_accepted DEFAULT false,
  accepted_player integer,
  answered_on timestamp,
  CONSTRAINT pk_team_member_invites PRIMARY KEY (league, season, team, email, role),
...
CREATE TABLE team_sponsorship (league integer,
  ...
  CONSTRAINT fk_team_sponsorship_team FOREIGN KEY (league, season, team) REFERENCES teams(league, season, number),
...
CREATE TABLE games (league integer,
  ...
  CONSTRAINT fk_games_team FOREIGN KEY (league, season, team) REFERENCES teams(league, season, number),
  CONSTRAINT fk_games_opponent FOREIGN KEY (league, season, opponent) REFERENCES teams(league, season, number)  
);
